...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>SenTagram - @yield('titulo')</title>
        @stack('styles')
        ...
        <body class="bg-gray-100">
                ...
                <div class="container mx-auto flex justify-between items-center">
                    ...
                    @auth
                        <nav class="flex gap-2 items-center">
                            <a class="flex items-center gap-2 border p-2 text-gray-600 rounded text-sm uppercase font-bold cursor-pointer"
            ...
            <footer class="mt-10 text-center p-5 text-gray-500 font-bold ">
                SenTagram - Todos los derechos reservados {{ now()->year }}
            </footer>
